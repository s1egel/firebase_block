view: single_completed {
  sql_table_name: android.single_completed ;;
  ...
  dimension: media_item_id {
    type: string
    sql: ${TABLE}.media_item_id ;;
  }

  dimension: media_item_name {
    type: string
    sql: ${TABLE}.media_item_name ;;
  }
